...
# Projections
PFCdStrD1 = annProjection(pre=dPFC, post=StrD1_caud, target='exc', synapse=DAPostCovarianceNoThreshold_trace)
...
PFCdStrD2_caud = Projection(pre=Objectives,post=StrD2_caud,target='exc',synapse=DAPostCovarianceNoThreshold)
