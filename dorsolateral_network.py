...
VLVL_putamen.connect_all_to_all(weights=0.4)

# FF
CortexStrD1_putamen = ann.Projection(pre=InputLayer, post=latStrD1, target='exc', synapse=DAPostCovarianceNoThreshold)
CortexStrD1_putamen.connect_all_to_all(weights=0)
CortexStrD1_putamen.tau = 2200
CortexStrD1_putamen.regularization_threshold = 1.2
CortexStrD1_putamen.tau_alpha = 20.0
CortexStrD1_putamen.baseline_dopa = 0.1
CortexStrD1_putamen.K_dip = 0.1
CortexStrD1_putamen.K_burst = 1.2
CortexStrD1_putamen.threshold_post = 0.1
CortexStrD1_putamen.threshold_pre = 0.0
...
VLPM_putamen = ann.Projection(pre=VL, post=M1, target='exc')
VLPM_putamen.connect_one_to_one(weights=1.0) #1.0 #3.0
...
StrD1SNc_put.baseline_dopa = model_params['baseline_DA']
